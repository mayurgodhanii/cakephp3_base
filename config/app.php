...
//            'className' => 'Mail',
            ...
            'port' => 465,
            'timeout' => 30,
            'username' => 'mayur.openxcell@gmail.com',
            'password' => 'Mayur123!@#',
            'client' => null,
            'tls' => null,
            'className' => 'Smtp'
    ...
    'Datasources' => [
        'default' => [
            ...
            'username' => ($servername == "localhost") ? "root" : "root",
            'password' => ($servername == "localhost") ? "" : "",
            'database' => ($servername == "localhost") ? "cakephp3" : "cakephp3",
            'encoding' => 'utf8',
            'timezone' => 'UTC',
            'cacheMetadata' => true,
            /**
